...
namespace V4mvc
{
    public partial class ServiceProxyClient
    {
        ...
        public ObservableCollection<Workers> BuscarFuncionariosPases(ref Workers worker)
        {
            try
            {
                return this.BL_Workers.BuscarFuncionariosPases(ref worker);
            }
            catch (Exception ex)
            { throw ex; }
        }
        public ObservableCollection<Workers> BuscarFuncionariosPasesAutorizador(ref Workers worker) {
            try
            {
                return this.BL_Workers.BuscarFuncionariosPasesAutorizador(ref worker);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public ObservableCollection<Workers> BuscarFuncionariosPasesSolicita_Visita(ref Workers worker) {
            try
            {
                return this.BL_Workers.BuscarFuncionariosPasesSolicita_Visita(ref worker);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public Workers BuscarFuncionariosPases_NumRegistros(String searchRUT, String searchNOMBRES, String searchAPELLIDOS, String searchEMPRESA, string IDEMPRESA)
        {
            try
            {
                return this.BL_Workers.BuscarFuncionariosPases_NumRegistros(searchRUT, searchNOMBRES, searchAPELLIDOS, searchEMPRESA, IDEMPRESA);
            }
            catch (Exception ex)
            { throw ex; }
        }
        ...
        public bool SaveWorkersAutorizacionesFuncionariosCtta(Workers workers)
        {
            try
            {
                return this.BL_Workers.SaveWorkersAutorizacionesFuncionariosCtta(workers);
            }
            catch (Exception ex)
            { throw ex; }
        }
