...
namespace V4mvc
{
    public partial class ServiceProxyClient
    {
        ...
        public ObservableCollection<Transport> GetAllTransportDatatablesCtta(ref JqueryDatatableParam model, out int iTotalCount)
        {
            try
            {
                return this.BL_Transport.GetAllTransportDatatablesCtta(ref model, out iTotalCount);
            }
            catch (Exception ex)
            { throw ex; }
        }
        ...
        public int GetTransportCumpleCertificacion_Ctta(string PATENTE, int? TIPO,string DIVCOD)
        {
            try
            {
                return this.BL_Transport.GetTransportCumpleCertificacion_Ctta(PATENTE,TIPO, DIVCOD);
            }
            catch (Exception ex)
            { throw ex; }
        }
        public Transport GetDataByPatente_VehiculosCtta(string patente)
        {
            try
            {
                return this.BL_Transport.GetDataByPatente_VehiculosCtta(patente);
            }
            catch (Exception ex)
            { throw ex; }
        }
        ...
        public bool DeleteTransportCtta(string PATENTE, string IDEMPRESA)
        {
            try
            {
                return this.BL_Transport.DeleteTransportCtta(PATENTE, IDEMPRESA);
            }
            catch (Exception ex)
            { throw ex; }
        }
        ...
        public bool SaveTransport_VehiculosCtta(Transport vehiculo)
        {
            try
            {
                return this.BL_Transport.SaveTransport_VehiculosCtta(vehiculo);
            }
            catch (Exception ex)
            { throw ex; }
        }
