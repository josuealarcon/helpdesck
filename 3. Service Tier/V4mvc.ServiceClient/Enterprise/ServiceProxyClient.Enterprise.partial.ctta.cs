...
namespace V4mvc
{
	public partial class ServiceProxyClient
	{
        ...
        public Enterprise GetEnterpriseTransport_Ctta(string DIVCOD, string PATENTE, string IDEMPRESA)
        {
            try
            {
                return this.BL_Enterprise.GetEnterpriseTransport_Ctta(DIVCOD,PATENTE,IDEMPRESA);
            }
            catch (Exception ex)
            { throw ex; }
        }
