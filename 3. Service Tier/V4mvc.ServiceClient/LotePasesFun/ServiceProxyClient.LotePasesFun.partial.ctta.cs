...
namespace V4mvc
{
    public partial class ServiceProxyClient
    {
        ...
        public bool SavePase_PasesCtta(int IDPASE, string ID_EMPRESA, string USUARIO, ObservableCollection<LotePasesFun> funcionarios, ObservableCollection<LotePasesFun> rem_funcionarios, ObservableCollection<LotePasesFun> vehiculos, ObservableCollection<LotePasesFun> rem_vehiculos)
        {
            try
            {
                return this.BL_LotePasesFun.SavePase_PasesCtta(IDPASE, ID_EMPRESA, USUARIO, funcionarios, rem_funcionarios, vehiculos, rem_vehiculos);
            }
            catch (Exception ex)
            { throw ex; }
        }
