...
namespace V4mvc
{
	public partial interface IServiceProxyClient
	{
        ...
        int ValidarFuncionarioPase(string RUT, int IDPASE, string DIVISION, string TIPOPASE, string FEC_INI, string FEC_FIN, string TABLA);
        ...
        bool SavePase_PasesCtta(int IDPASE,string DIVCOD, string ID_EMPRESA, string USUARIO, ObservableCollection<LotePasesFun> funcionarios, ObservableCollection<LotePasesFun> rem_funcionarios, ObservableCollection<LotePasesFun> vehiculos, ObservableCollection<LotePasesFun> rem_vehiculos);
