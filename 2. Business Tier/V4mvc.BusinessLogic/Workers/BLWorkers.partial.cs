...
namespace V4mvc.BusinessLogic
{
    public partial class BLWorkers
    {
        ...
        public ObservableCollection<Workers> BuscarFuncionariosPases(ref Workers worker)
        {
            try
            {
                return this.Repository.BuscarFuncionariosPases(ref worker);
            }
            catch (Exception ex)
            { throw ex; }
        }
        public ObservableCollection<Workers> BuscarFuncionariosPasesAutorizador(ref Workers worker) {
            try
            {
                return this.Repository.BuscarFuncionariosPasesAutorizador(ref worker);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public ObservableCollection<Workers> BuscarFuncionariosPasesSolicita_Visita(ref Workers worker) {
            try
            {
                return this.Repository.BuscarFuncionariosPasesSolicita_Visita(ref worker);
            }
            catch (Exception ex)
            { throw ex; }
        }
        public Workers BuscarFuncionariosPases_NumRegistros(String searchRUT, String searchNOMBRES, String searchAPELLIDOS, String searchEMPRESA, string IDEMPRESA)
        {
            try
            {
                return this.Repository.BuscarFuncionariosPases_NumRegistros(searchRUT, searchNOMBRES, searchAPELLIDOS, searchEMPRESA, IDEMPRESA);
            }
            catch (Exception ex)
            { throw ex; }
        }
        ...
        public Workers GetOneWorkers_PasesCtta(string RUT, int IDPASE, string ID_EMPRESA, string DIVCOD, string FEC_INI, string FEC_FIN, string TIPO_PASE)
        {
            try
            {
                ...
                worker.ZONAS_ACCESO= Local_Repository.GetAllLocalAcceso_v2_PasesCtta(RUT, DIVCOD, IDPASE, ID_EMPRESA);
                return worker;
            }
            catch (Exception ex)
            { throw ex; }
        ...
        public bool SaveWorkersAutorizacionesFuncionariosCtta(Workers workers)
        {
            try
            {
                return this.Repository.SaveWorkersAutorizacionesFuncionariosCtta(workers);
            }
            catch (Exception ex)
            { throw ex; }
        }
