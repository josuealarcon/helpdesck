    ...
    public partial class DAWorkers
    {
        ...
        public ObservableCollection<Workers> GetWorkersSearcherMdte(ref Workers model)
        {
            try
            {
                ...
                Instance.DAAgregarParametro("@RUT", model.COL0, SqlDbType.NVarChar, 10, ParameterDirection.Input);
                Instance.DAAgregarParametro("@NOMBRES", model.COL1, SqlDbType.NVarChar, 50, ParameterDirection.Input);
                Instance.DAAgregarParametro("@APELLIDOS", model.COL2, SqlDbType.NVarChar, 50, ParameterDirection.Input);
                Instance.DAAgregarParametro("@ACRONIMO", model.COL3, SqlDbType.NVarChar, 50, ParameterDirection.Input);
        ...
        public ObservableCollection<Workers> BuscarFuncionariosPases(ref Workers worker)
        {
            try
            {
                ObservableCollection<Workers> items = new ObservableCollection<Workers>();
                Workers item = new Workers();
                Instance.DAAsignarProcedure("V4MVC_WORKERS_SELECT_FUNCIONARIO_PASE_BUSCADORCTTA");
                Instance.DAAgregarParametro("@START", worker.START, SqlDbType.Int, 4, ParameterDirection.Input);
                Instance.DAAgregarParametro("@LENGTH", worker.LENGTH, SqlDbType.Int, 4, ParameterDirection.Input);
                Instance.DAAgregarParametro("@COLUMN", worker.COLUMN, SqlDbType.NVarChar, 4, ParameterDirection.Input);
                Instance.DAAgregarParametro("@DIRECTION", worker.DIRECTION, SqlDbType.NVarChar, 4, ParameterDirection.Input);
                Instance.DAAgregarParametro("@RUT", worker.COL0, SqlDbType.NVarChar, 20, ParameterDirection.Input);
                Instance.DAAgregarParametro("@NOMBRES", worker.COL1, SqlDbType.NVarChar, 50, ParameterDirection.Input);
                Instance.DAAgregarParametro("@APELLIDOS", worker.COL2, SqlDbType.NVarChar, 50, ParameterDirection.Input);
                Instance.DAAgregarParametro("@EMPRESA", worker.COL3, SqlDbType.NVarChar, 50, ParameterDirection.Input);
                Instance.DAAgregarParametro("@IDEMPRESA", worker.IDEMPRESA, SqlDbType.NVarChar, 20, ParameterDirection.Input);
                using (IDataReader reader = Instance.DAExecuteReader())
                {
                    while (reader.Read())
                    {
        ...
        public ObservableCollection<Workers> BuscarFuncionariosPasesAutorizador(ref Workers worker)
        {
            try
            {
                ObservableCollection<Workers> items = new ObservableCollection<Workers>();
                Workers item = new Workers();
                Instance.DAAsignarProcedure("V4MVC_WORKERS_SELECT_FUNCIONARIO_PASEAUTORIZADOR_CTTA");
                Instance.DAAgregarParametro("@START", worker.START, SqlDbType.Int, 4, ParameterDirection.Input);
                Instance.DAAgregarParametro("@LENGTH", worker.LENGTH, SqlDbType.Int, 4, ParameterDirection.Input);
                Instance.DAAgregarParametro("@COLUMN", worker.COLUMN, SqlDbType.NVarChar, 4, ParameterDirection.Input);
                Instance.DAAgregarParametro("@DIRECTION", worker.DIRECTION, SqlDbType.NVarChar, 4, ParameterDirection.Input);
        ...
        public ObservableCollection<Workers> BuscarFuncionariosPasesSolicita_Visita(ref Workers worker)
        {
            try
            {
                ObservableCollection<Workers> items = new ObservableCollection<Workers>();
                Workers item = new Workers();
                Instance.DAAsignarProcedure("V4MVC_WORKERS_SELECT_FUNCIONARIO_PASESVISITA_CTTA");
                Instance.DAAgregarParametro("@START", worker.START, SqlDbType.Int, 4, ParameterDirection.Input);
                Instance.DAAgregarParametro("@LENGTH", worker.LENGTH, SqlDbType.Int, 4, ParameterDirection.Input);
                Instance.DAAgregarParametro("@COLUMN", worker.COLUMN, SqlDbType.NVarChar, 4, ParameterDirection.Input);
                Instance.DAAgregarParametro("@DIRECTION", worker.DIRECTION, SqlDbType.NVarChar, 4, ParameterDirection.Input);
        ...
        public Workers BuscarFuncionariosPases_NumRegistros(String searchRUT, String searchNOMBRES, String searchAPELLIDOS, String searchEMPRESA, string IDEMPRESA)
        {
            try
            {
                Workers item = new Workers();
        ...
        public bool SaveWorkersLaboralesCtta(ref Workers item)
        {
            try
            {
                ...
                Instance.DAAgregarParametro("@TURNO", item.TURNO, SqlDbType.NVarChar, 30, ParameterDirection.Input);
        ...
        public bool UpdateWorkersConductores_Ctta(string RUT, string CLASE, string LICCONDUC, string ESCOLTA)
        {
            try
            {
                Instance.DAAsignarProcedure("V4MVC_WORKERS_UPDATE_CONDUCTORES_CTTA");
                Instance.DAAgregarParametro("@RUT", RUT, SqlDbType.NVarChar, 20, ParameterDirection.Input);
                Instance.DAAgregarParametro("@CLASE", CLASE, SqlDbType.NVarChar, 100, ParameterDirection.Input);
                Instance.DAAgregarParametro("@LICCONDUC", LICCONDUC, SqlDbType.NVarChar, 100, ParameterDirection.Input);
                Instance.DAAgregarParametro("@ESCOLTA", ESCOLTA, SqlDbType.NVarChar, 100, ParameterDirection.Input);
                if (Instance.DAExecuteNonQuery() > 0)
                { return true; }
                else
                { return false; }
        ...
        public bool SaveWorkersAutorizacionesFuncionariosCtta(Workers workers)
        {
            try
            {
                Instance.DAAsignarProcedure("V4MVC_WORKERS_UPDATE_AUTORIZACIONES_CTTA");
                Instance.DAAgregarParametro("@RUT", workers.RUT, SqlDbType.NVarChar, 20, ParameterDirection.Input);
                Instance.DAAgregarParametro("@AUTCASINO", workers.AUTCASINO, SqlDbType.NVarChar, 2, ParameterDirection.Input);
                Instance.DAAgregarParametro("@AUTORVISITA", workers.AUTORVISITA, SqlDbType.NVarChar, 20, ParameterDirection.Input);
                Instance.DAAgregarParametro("@AUTOR", workers.AUTOR, SqlDbType.NVarChar, 20, ParameterDirection.Input);
                Instance.DAAgregarParametro("@USUARIO", workers.USUARIO, SqlDbType.NVarChar, 20, ParameterDirection.Input);
