...
namespace V4mvc.DataAccess
{
    public partial class DADocs
    {
        ...
        public ObservableCollection<Docs> GetAllDocumentacionDocsCtta(string DIVCOD, int? ID_DOC_OPCION)
        {
            try
            {
                ...
                //{
                //    SqlCommand Instance = new SqlCommand("V4MVC_DOCS_SELECT_DOCUMENTOS_CTTA", connection);
        ...
        public ObservableCollection<Docs> GetAllDocumentacionVehiculosCtta(string PATENTE, string DIVCOD)
        {
            try
            {
                ObservableCollection<Docs> items = new ObservableCollection<Docs>();
        ...
        public bool SaveDocument_EmpresaCtta(ref Docs item, out bool result)
        {
            try
            {
                ...
                Instance.DAAgregarParametro("@DIRECCION", item.DIRECCION, SqlDbType.NVarChar, 150, ParameterDirection.Input);
