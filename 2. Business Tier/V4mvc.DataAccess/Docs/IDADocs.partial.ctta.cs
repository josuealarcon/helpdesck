...
namespace V4mvc.DataAccess
{
    public partial interface IDADocs
    {
        ...
        ObservableCollection<Docs> GetAllDocumentacionDocsCtta(string DIVCOD, int? ID_DOC_OPCION, string RUT, string IDEMPRESA);
        ...
        ObservableCollection<Docs> GetAllDocumentacionVehiculosCtta(string DIVCOD, string PATENTE);
