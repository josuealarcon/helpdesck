...
namespace V4mvc.DataAccess
{
    public partial class DALotePasesFun
    {
        ...
        public int ValidarFuncionarioPase(string RUT, int IDPASE, string DIVISION, string TIPOPASE, string FEC_INI, string FEC_FIN, string TABLA) {
            ...
            {
                LotePasesFun item = new LotePasesFun();
                Instance.DAAsignarProcedure("V4MVC_LOTEPASESFUN_SELECT_VALIDA_DATOS_PASE_CTTA");
                Instance.DAAgregarParametro("@RUT", RUT, SqlDbType.NVarChar, 11, ParameterDirection.Input);
                Instance.DAAgregarParametro("@IDPASE", IDPASE, SqlDbType.Int, 4, ParameterDirection.Input);
                Instance.DAAgregarParametro("@DIVISION", DIVISION, SqlDbType.NVarChar, 4, ParameterDirection.Input);
                Instance.DAAgregarParametro("@TIPOPASE", TIPOPASE, SqlDbType.NVarChar, 9, ParameterDirection.Input);
                Instance.DAAgregarParametro("@FINI", FEC_INI, SqlDbType.NVarChar, 8, ParameterDirection.Input);
                Instance.DAAgregarParametro("@FFIN", FEC_FIN, SqlDbType.NVarChar, 8, ParameterDirection.Input);
                Instance.DAAgregarParametro("@TABLA", TABLA, SqlDbType.NVarChar, 12, ParameterDirection.Input);
                Instance.DAExecuteNonQuery();
                using (IDataReader reader = Instance.DAExecuteReader())
                {
                    if (reader.Read())
        ...
        public bool SaveLotePasesFun_PasesCtta(LotePasesFun funcionario)
        {
            try
            {
                if (funcionario.CONDUCE_TXT == "SI")
                    funcionario.CONDUCE = true;
        ...
        public bool SaveLotePasesFun_PasesVisitaCtta(LotePasesFun FuncionarioVisita)
        {
            try
            {
                Instance.DAAsignarProcedure("V4MVC_LOTEPASESFUN_INSERT_PASESVISITA_CTTA");
                Instance.DAAgregarParametro("@PASE_ID", FuncionarioVisita.IDPASE, SqlDbType.Int, 4, ParameterDirection.Input);
                Instance.DAAgregarParametro("@RUT_FUNC", FuncionarioVisita.RUTLOTE, SqlDbType.NVarChar, 20, ParameterDirection.Input);
                Instance.DAAgregarParametro("@IDEMPRESA", FuncionarioVisita.ID_EMPRESA, SqlDbType.NVarChar, 20, ParameterDirection.Input);
                Instance.DAAgregarParametro("@NOMBRES", FuncionarioVisita.NOMBRESLT, SqlDbType.NVarChar, 50, ParameterDirection.Input);
                Instance.DAAgregarParametro("@APELLIDOS", FuncionarioVisita.APELLIDOSLT, SqlDbType.NVarChar, 50, ParameterDirection.Input);
                Instance.DAAgregarParametro("@LICONDLT", FuncionarioVisita.CONDUCE_TXT, SqlDbType.NVarChar, 8, ParameterDirection.Input);
                Instance.DAAgregarParametro("@FINICIO", FuncionarioVisita.LOTEFINICIO, SqlDbType.NVarChar, 8, ParameterDirection.Input);
                Instance.DAAgregarParametro("@FFINAL", FuncionarioVisita.LOTEFFINAL, SqlDbType.NVarChar, 8, ParameterDirection.Input);
                if (Instance.DAExecuteNonQuery() > 0)
                { return true; }
                else
                { return false; }
        ...
        public bool SaveLotePasesFunV2_PasesVisitaCtta(LotePasesFun VehiculoVisita)
        {
            try
            {
                Instance.DAAsignarProcedure("V4MVC_LOTEPASESFUNV2_INSERT_PASESVISITA_CTTA");
                Instance.DAAgregarParametro("@PASE_ID", VehiculoVisita.IDPASE, SqlDbType.Int, 4, ParameterDirection.Input);
                Instance.DAAgregarParametro("@PATENTE", VehiculoVisita.PATENTE, SqlDbType.NVarChar, 20, ParameterDirection.Input);
                Instance.DAAgregarParametro("@IDEMPRESA", VehiculoVisita.ID_EMPRESA, SqlDbType.NVarChar, 20, ParameterDirection.Input);
                Instance.DAAgregarParametro("@MARCA", VehiculoVisita.MARCA, SqlDbType.NVarChar, 20, ParameterDirection.Input);
                Instance.DAAgregarParametro("@MODELO", VehiculoVisita.MODELO, SqlDbType.NVarChar, 20, ParameterDirection.Input);
                Instance.DAAgregarParametro("@TIPOVEHI", VehiculoVisita.TIPOVEHI, SqlDbType.NVarChar, 20, ParameterDirection.Input);
                Instance.DAAgregarParametro("@ANIO", VehiculoVisita.ANIO, SqlDbType.NVarChar, 4, ParameterDirection.Input);
                if (Instance.DAExecuteNonQuery() > 0)
                { return true; }
                else
                { return false; }
