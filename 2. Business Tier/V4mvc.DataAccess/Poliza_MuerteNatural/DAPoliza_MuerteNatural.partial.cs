...
{
    public partial class DAPoliza_MuerteNatural
    {
        #region [ Consultas ]
        public ObservableCollection<Poliza_MuerteNatural> GetAllPolizaMuerteNatural_ControlLaboralCtta(string IDEMPRESA)
        {
            try
            {
                ObservableCollection<Poliza_MuerteNatural> items = new ObservableCollection<Poliza_MuerteNatural>();
                Poliza_MuerteNatural item = new Poliza_MuerteNatural();
                Instance.DAAsignarProcedure("V4MVC_POLIZA_MUERTENATURAL_SELECT_CONTROLLABORAL_CTTA");
                Instance.DAAgregarParametro("@IDEMPRESA", IDEMPRESA, SqlDbType.NVarChar, 11, ParameterDirection.Input);
                using (IDataReader reader = Instance.DAExecuteReader())
                {
                    while (reader.Read())
                    {
                        item = new Poliza_MuerteNatural();
        ...
        public Poliza_MuerteNatural GetOnePolizaMuerteNat_ControlLaboralCtta(int ID_DOC, string EMPRESA, string PERIODO)
        {
            ...
            {
                Poliza_MuerteNatural item = new Poliza_MuerteNatural();
                Instance.DAAsignarProcedure("V4MVC_POLIZA_MUERTENATURAL_SELECT_ONE_CONTROLLABORAL_CTTA");
        ...
        public Poliza_MuerteNatural GetOnePolizaMuerteNat_v2_ControlLaboralCtta(string EMPRESA, string PERIODO)
        {
            ...
            {
                Poliza_MuerteNatural item = new Poliza_MuerteNatural();
                //V4MVC_POLIZA_MUERTENATURAL_SELECT_ONE2_CONTROLLABORAL_CTTA
                Instance.DAAsignarProcedure("V4MVC_POLIZA_MUERTENATURAL_SELECT_ONE_V2_CONTROLLABORAL_CTTA");
                Instance.DAAgregarParametro("@IDEMPRESA", EMPRESA, SqlDbType.NVarChar, 10, ParameterDirection.Input);
                Instance.DAAgregarParametro("@PERIODO", PERIODO, SqlDbType.NVarChar, 6, ParameterDirection.Input);
                using (IDataReader reader = Instance.DAExecuteReader())
                {
        ...
        public Poliza_MuerteNatural GetOnePolizaMuerteNat_v3_ControlLaboralCtta(int ID_DOC, string EMPRESA, string PERIODO)
        {
            ...
            {
                Poliza_MuerteNatural item = new Poliza_MuerteNatural();
                //V4MVC_POLIZA_MUERTENATURAL_SELECT_ONE3_CONTROLLABORAL_CTTA
                Instance.DAAsignarProcedure("V4MVC_POLIZA_MUERTENATURAL_SELECT_ONE_V3_CONTROLLABORAL_CTTA");
                Instance.DAAgregarParametro("@ID_DOC", ID_DOC, SqlDbType.Int, 8, ParameterDirection.Input);
                Instance.DAAgregarParametro("@IDEMPRESA", EMPRESA, SqlDbType.NVarChar, 10, ParameterDirection.Input);
                Instance.DAAgregarParametro("@PERIODO", PERIODO, SqlDbType.NVarChar, 6, ParameterDirection.Input);
                using (IDataReader reader = Instance.DAExecuteReader())
        ...
        public bool InsertPolizaMuerteNat_ControlLaboralCtta(Poliza_MuerteNatural model, out int RET_CODE)
        {
            try
            {
                RET_CODE = -1;

                Instance.DAAsignarProcedure("V4MVC_POLIZA_MUERTENATURAL_INSERT_CONTROLLABORAL_CTTA");
        ...
        public bool UpdatePolizaMuerteNat_ControlLaboralCtta(Poliza_MuerteNatural model, out int RET_CODE)
        {
            try
            {
                RET_CODE = -1;

                Instance.DAAsignarProcedure("V4MVC_POLIZA_MUERTENATURAL_UPDATE_CONTROLLABORAL_CTTA");
        ...
        public bool UpdatePolizaMuerteNat_v3_ControlLaboralCtta(Poliza_MuerteNatural model)
        {
            try
            {
                //V4MVC_POLIZA_MUERTENATURAL_UPDATE3_CONTROLLABORAL_CTTA
                Instance.DAAsignarProcedure("V4MVC_POLIZA_MUERTENATURAL_UPDATE_V3_CONTROLLABORAL_CTTA");
        ...
        public bool DelPolizaMuerteNatDispFile_ControlLaboralCtta(ref Poliza_MuerteNatural modelo)
        {
            try
            {
                //V4MVC_POLIZA_MUERTENATURAL_UPDATE2_CONTROLLABORAL_CTTA
                Instance.DAAsignarProcedure("V4MVC_POLIZA_MUERTENATURAL_UPDATE_V2_CONTROLLABORAL_CTTA");
        ...
        public bool DelPolizaMuerteNat_ControlLaboralCtta(ref Poliza_MuerteNatural modelo)
        {
            try
            {
                ...
                Instance.DAAsignarProcedure("V4MVC_POLIZA_MUERTENATURAL_DELETE_CONTROLLABORAL_CTTA");
                Instance.DAAgregarParametro("@IDEMPRESA", modelo.EMPRESA, SqlDbType.NVarChar, 10, ParameterDirection.Input);
                Instance.DAAgregarParametro("@PERIODO", modelo.PERIODO, SqlDbType.NVarChar, 6, ParameterDirection.Input);
                Instance.DAAgregarParametro("@USUARIO", modelo.USUARIO, SqlDbType.NVarChar, 10, ParameterDirection.Input);
                Instance.DAAgregarParametro("@DISPUTA_ID", modelo.DISPUTA_ID, SqlDbType.Int, 8, ParameterDirection.Input);
