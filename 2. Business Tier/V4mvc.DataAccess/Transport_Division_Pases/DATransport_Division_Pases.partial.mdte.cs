	...
	public partial class DATransport_Division_Pases
	{
        ...
        public ObservableCollection<Transport_Division_Pases> GetAllTransportDivPases_CertificacionMdte(string DIVCOD, string PATENTE, string TIPO)
        {
            try
            {
                ...
                Instance.DAAsignarProcedure("V4MVC_TRANSPORT_DIVISION_PASES_SELECT_CERTIFICACION_MDTE");
                ...
                Instance.DAAgregarParametro("@TIPO", TIPO, SqlDbType.NVarChar, 10, ParameterDirection.Input);
