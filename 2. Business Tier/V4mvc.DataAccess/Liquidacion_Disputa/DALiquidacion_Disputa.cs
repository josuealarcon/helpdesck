...
{
	public partial class DALiquidacion_Disputa : IDALiquidacion_Disputa
	{
		#region [ Propiedades ]
		public IUnityContainer ContainerService { get; set; }
		public LoaderEntity<Liquidacion_Disputa> Loader { get; set; }
        public IDataAccessEnterprise Instance { get; set; }
        #endregion

        #region [ Constructores ]
        public DALiquidacion_Disputa(IDataAccessEnterprise container)
		{
			this.Instance = container;
			Loader = new LoaderEntity<Liquidacion_Disputa>();
		...
		public Liquidacion_Disputa GetOne(Guid Codigo)
		{ throw new NotImplementedException(); }

		#endregion

		#region [ Metodos ]
		public bool Save(ref Liquidacion_Disputa item)
		{
			try
			{
