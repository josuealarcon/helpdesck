...
namespace V4mvc.DataAccess
{
    public partial class DAWorkerZonaPaseHst
    {
        ...
        public bool SaveWorkerZonaPaseHst_PasesCtta(int IDPASE, string RUT, string ID_EMPRESA)
        {
            try
            {
                Instance.DAAsignarProcedure("V4MVC_WORKERS_ZONA_PASE_HST_INSERT_PASES_CTTA");
