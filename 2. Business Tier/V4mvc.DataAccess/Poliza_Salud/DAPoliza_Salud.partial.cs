...
{
    public partial class DAPoliza_Salud
    {
        #region [ Consultas ]
        public ObservableCollection<Poliza_Salud> GetAllPolizaSalud_ControlLaboralCtta(string IDEMPRESA)
        {
            try
            {
                ObservableCollection<Poliza_Salud> items = new ObservableCollection<Poliza_Salud>();
                Poliza_Salud item = new Poliza_Salud();
                Instance.DAAsignarProcedure("V4MVC_POLIZA_SALUD_SELECT_CONTROLLABORAL_CTTA");
                Instance.DAAgregarParametro("@IDEMPRESA", IDEMPRESA, SqlDbType.NVarChar, 11, ParameterDirection.Input);
                using (IDataReader reader = Instance.DAExecuteReader())
                {
                    while (reader.Read())
                    {
                        item = new Poliza_Salud();
        ...
        public Poliza_Salud GetOnePolizaSalud_ControlLaboralCtta(int ID_DOC, string EMPRESA, string PERIODO)
        {
            ...
            {
                Poliza_Salud item = new Poliza_Salud();
                Instance.DAAsignarProcedure("V4MVC_POLIZA_SALUD_SELECT_ONE_CONTROLLABORAL_CTTA");
        ...
        public Poliza_Salud GetOnePolizaSalud_v3_ControlLaboralCtta(int ID_DOC, string EMPRESA, string PERIODO)
        {
            ...
            {
                Poliza_Salud item = new Poliza_Salud();
                //V4MVC_POLIZA_SALUD_SELECT_ONE3_CONTROLLABORAL_CTTA
                Instance.DAAsignarProcedure("V4MVC_POLIZA_SALUD_SELECT_ONE_V3_CONTROLLABORAL_CTTA");
                Instance.DAAgregarParametro("@ID_DOC", ID_DOC, SqlDbType.Int, 8, ParameterDirection.Input);
                Instance.DAAgregarParametro("@IDEMPRESA", EMPRESA, SqlDbType.NVarChar, 10, ParameterDirection.Input);
                Instance.DAAgregarParametro("@PERIODO", PERIODO, SqlDbType.NVarChar, 6, ParameterDirection.Input);
                using (IDataReader reader = Instance.DAExecuteReader())
        ...
        #region [ Metodos ]
        public bool InsertPolizaSalud_ControlLaboralCtta(Poliza_Salud model, out int RET_CODE)
        {
            try
            {
                RET_CODE = -1;

                Instance.DAAsignarProcedure("V4MVC_POLIZA_SALUD_INSERT_CONTROLLABORAL_CTTA");
        ...
        public bool UpdatePolizaSalud_ControlLaboralCtta(Poliza_Salud model, out int RET_CODE)
        {
            try
            {
                RET_CODE = -1;

                Instance.DAAsignarProcedure("V4MVC_POLIZA_SALUD_UPDATE_CONTROLLABORAL_CTTA");
        ...
        public bool UpdatePolizaSalud_v3_ControlLaboralCtta(Poliza_Salud model)
        {
            try
            {
                //V4MVC_POLIZA_SALUD_UPDATE3_CONTROLLABORAL_CTTA
                Instance.DAAsignarProcedure("V4MVC_POLIZA_SALUD_UPDATE_V3_CONTROLLABORAL_CTTA");
        ...
        public bool DelPolizaSaludDispFile_ControlLaboralCtta(ref Poliza_Salud modelo)
        {
            try
            {
                //V4MVC_POLIZA_SALUD_UPDATE2_CONTROLLABORAL_CTTA
                Instance.DAAsignarProcedure("V4MVC_POLIZA_SALUD_UPDATE_V2_CONTROLLABORAL_CTTA");
        ...
        public bool DelPolizaSalud_ControlLaboralCtta(ref Poliza_Salud modelo)
        {
            try
            {
                Instance.DAAsignarProcedure("V4MVC_POLIZA_SALUD_DELETE_CONTROLLABORAL_CTTA");
                Instance.DAAgregarParametro("@IDEMPRESA", modelo.EMPRESA, SqlDbType.NVarChar, 10, ParameterDirection.Input);
                Instance.DAAgregarParametro("@PERIODO", modelo.PERIODO, SqlDbType.NVarChar, 6, ParameterDirection.Input);
                Instance.DAAgregarParametro("@USUARIO", modelo.USUARIO, SqlDbType.NVarChar, 10, ParameterDirection.Input);
                Instance.DAAgregarParametro("@DISPUTA_ID", modelo.DISPUTA_ID, SqlDbType.Int, 8, ParameterDirection.Input);
