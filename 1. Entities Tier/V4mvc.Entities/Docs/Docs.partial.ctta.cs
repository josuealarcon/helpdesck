...
namespace V4mvc.Entities
{
    public partial class Docs
    {
        ...
        public ObservableCollection<Docs> ListaGrupo_Uno { get; set; }
        public ObservableCollection<Docs> ListaGrupo_Dos { get; set; }
        ...
        public ObservableCollection<DocsGrupos> DocGrupos { get; set; }    
