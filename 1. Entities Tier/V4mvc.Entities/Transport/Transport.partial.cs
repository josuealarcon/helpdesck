...
namespace V4mvc.Entities
{
	public partial class Transport
	{
        ...
        public string PATENTE_FORMATEADA {
            get {
        ...
        public string RUT_PROPIETARIO_FORMATO
        {
            get 
            {
                return (Utils.strRut(RUT_PROPIETARIO));
            }
        }
        ...
        public string PERMISOCIRC_GML
        {
            get
            {
                return (Utils.Fec_User(PERMISOCIRC, Utils.Formato_Fecha.GuionMesLetras));
            }
        }
        public string FECSEGURO_GML
        {
            get
            {
                return (Utils.Fec_User(FECSEGURO, Utils.Formato_Fecha.GuionMesLetras));
            }
        }
        public string REVTEC_GML
        {
            get
            {
                return (Utils.Fec_User(REVTEC, Utils.Formato_Fecha.GuionMesLetras));
            }
        }
        public string AREAS_ASIGNADAS { get; set; }
    }
}
