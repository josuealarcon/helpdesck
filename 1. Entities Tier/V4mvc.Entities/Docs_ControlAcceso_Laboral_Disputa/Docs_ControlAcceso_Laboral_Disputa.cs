...
{
	[Serializable()]
	public partial class Docs_ControlAcceso_Laboral_Disputa
	{
		#region [ Variables ]
		...
		/// <summary>
		/// Inicializar una nueva instancia de la clase Docs_ControlAcceso_Laboral_Disputa.
		/// </summary>
		public Docs_ControlAcceso_Laboral_Disputa()
		{  }
		#endregion
