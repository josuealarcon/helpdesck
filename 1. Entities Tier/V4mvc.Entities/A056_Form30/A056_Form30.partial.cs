...
namespace V4mvc.Entities
{
    ...
    public partial class A056_Form30
    {
        #region [ Variables ]
        ...
        public String FRMT_VIGENCIA
        {
            get
            {
                return (Utils.Fec_User(VIGENCIA, Utils.Formato_Fecha.GuionMesLetras));
            }
        }

        public String FRMT_EMPRESA
        {
            get
            {
        ...
        public int MAX_FILESIZE_MB { get; set; } = 1;
