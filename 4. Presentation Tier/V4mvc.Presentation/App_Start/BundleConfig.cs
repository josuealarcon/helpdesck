...
namespace V4mvc.Presentation
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // CSS style (Media: Print, etc)
            bundles.Add(new StyleBundle("~/Media/css").Include(
                      "~/Content/media/informes.print.css"));
            ...
            // LazyLoading
            bundles.Add(new StyleBundle("~/plugins/lazyloading").Include(
                        "~/Scripts/lazyloading.js"));

            // iCheck-bootstrap css styles
            bundles.Add(new StyleBundle("~/Content/plugins/iCheck-bootstrap/iCheckBootstrapStyles").Include(
                      "~/Content/plugins/iCheck-bootstrap/icheck-bootstrap.css"));

            // Searchers
            bundles.Add(new StyleBundle("~/plugins/searchers").Include(
                        "~/Scripts/searchers.js"));
            ...
            // tabletranspose 
            bundles.Add(new ScriptBundle("~/plugins/tabletranspose").Include(
                      "~/Scripts/plugins/tabletranspose/jquery.table.transpose.js"));
            ...
            // datetableCheckboxes styles
            bundles.Add(new StyleBundle("~/plugins/datatablescheckboxesStyles").Include(
                      "~/Content/plugins/datatables-checkboxes/dataTables.checkboxes.css"));

            // datetableCheckboxes 
            bundles.Add(new ScriptBundle("~/plugins/datatablescheckboxes").Include(
                      "~/Scripts/plugins/datatables-checkboxes/dataTables.checkboxes.min.js"));
            ...
            // Utils 
            bundles.Add(new StyleBundle("~/plugins/utils").Include(
                        "~/Scripts/utils.js"));

            // Upload 
            bundles.Add(new StyleBundle("~/plugins/upload").Include(
                        "~/Scripts/plugins/upload/jquery.tmpl.min.js"));

            // WaitMe Styles
            bundles.Add(new StyleBundle("~/plugins/waitMeStyles").Include(
                      "~/Content/plugins/waitMe/waitMe.min.css"));

            // WaitMe 
            bundles.Add(new ScriptBundle("~/plugins/waitMe").Include(
                        "~/Scripts/plugins/waitMe/waitMe.min.js"));

            // excel-export(custom)
            bundles.Add(new ScriptBundle("~/plugins/excel-export").Include(
                        "~/Scripts/excel-export.js"));
            
            // global configurations(custom) 
            bundles.Add(new ScriptBundle("~/plugins/global-configs").Include(
                        "~/Scripts/global-configs.js"));

            // fullCalendar styles
            bundles.Add(new StyleBundle("~/plugins/paginationStyles").Include(
                      "~/Content/plugins/pagination/pagination.css"));

            // fullCalendar 
            bundles.Add(new ScriptBundle("~/plugins/pagination").Include(
                      "~/Scripts/plugins/pagination/pagination.js"));

            // Custom Print
            bundles.Add(new StyleBundle("~/bundles/custom-print").Include(
                        "~/Scripts/custom-print.js"));
        }
    }
}
